...
.. http:get::  /v2.3/agents/{agent_id:UUID}
...
.. http:post::  /v2.3/agents/{agent_id:UUID}
...
.. http:delete::  /v2.3/agents/{agent_id:UUID}
...
.. http:put::  /v2.3/agents/{agent_id:UUID}/reactivate
...
.. http:put::  /v2.3/agents/{agent_id:UUID}/stop
...
.. http:post::  /v2.3/allowlists/{runtime_policy_name:string}
...
.. http:get::  /v2.3/allowlists/[runtime_policy_name:string]
...
.. http:get::  /v2.3/mbpolicies/{policy_name:string}
